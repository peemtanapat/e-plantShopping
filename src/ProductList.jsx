          ...
          <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
            <h1 className="cart">
              ...
              >
                ...
                ></path>
                {/* 80 160 for 2 digits, 110 150 for 1 digit */}
                {addedToCart.length <= 9 ? (
                  <text x="110" y="150" fontSize={80} fill="white">
                    {addedToCart.length}
                  </text>
                ) : (
                  <text x="80" y="150" fontSize={80} fill="white">
                    {addedToCart.length}
                  </text>
                )}
              </svg>
            ...
            return (
              <div key={group.category}>
                <div className="plantname_heading">
                  <div className="plant_heading">{group.category}</div>
                </div>
                <div className="product-list">
                  {group.plants.map((plant) => {
                    const isAddedToCart = addedToCart.find(
